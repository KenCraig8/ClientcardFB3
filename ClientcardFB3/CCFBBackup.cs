...
namespace ClientcardFB3
{
    class CCFBBackup
    {
        ...
        public bool BackupDataBase(string fileName)
        {
            ...
            try
            {
                ...
                //Database db = sqlServer.Databases[connection.DataBaseName];

                sqlBackup.Database = connection.DatabaseName;
    ...
    private SqlConnection BackupConnection
    {
        get
        {
            ...
            ConnectionStringSettings settings = ConfigurationManager.ConnectionStrings["LibrarySystemBackUpConnection"];
