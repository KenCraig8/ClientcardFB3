...
namespace ClientcardFB3
{
    class RptEFAPSubcontractors
    {
        ...
        public void createReport(object saveAs, string templatePath, string totalLbs, string dollarsPerHr,
            string dollarsPerLbs, string preparedBy, string reportMonth)
        {
           ...
           // m_oBooks = null;
            ...
            try
            {
                ...
                m_oSheet.Range["Labor", missing].Value = dollarsPerHr;
                m_oSheet.Range["Food", missing].Value = dollarsPerLbs;
