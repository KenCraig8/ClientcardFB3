...
namespace ClientcardFB3
{
    public partial class FoodDonationsForm : Form
    {
        ...
        {
            InitializeComponent();
            spltcntrDailyLog.Visible = true;
            spltcntrEdit.Visible = false;
            ...
            foreach (TextBox tb in spltcntrEdit.Panel1.Controls.OfType<TextBox>())
            {
                tbList.Add(tb);
            }
        ...
        private void changedMode()
        {
            ...
            {
                spltcntrEdit.Panel1Collapsed = false;
                Application.DoEvents();
                SetDonorHistoryHeight();
                spltcntrEdit.Visible = true;
                spltcntrDailyLog.Visible = false;
            }
        }
        ...
        private void btnShowDnrHist_Click(object sender, EventArgs e)
        {
            if (lvFoodDonations.FocusedItem != null)
            {
                ...
                spltcntrDailyLog.Visible = false;
                spltcntrEdit.Panel1Collapsed = true;
                Application.DoEvents();
                SetDonorHistoryHeight();
                spltcntrEdit.Visible = true;
                loadDonorLogList(); 
        ...
        private void spltcntrEdit_SizeChanged(object sender, EventArgs e)
        {
            SetDonorHistoryHeight();
        }
        ...
        {
            if (spltcntrEdit.Panel1Collapsed == true)
                lvDonorHistory.Height = spltcntrEdit.Height - (tbDonorLbs.Top + tbDonorLbs.Height);
            else
                lvDonorHistory.Height = spltcntrEdit.Height - spltcntrEdit.SplitterDistance - (tbDonorLbs.Top + tbDonorLbs.Height);
        }
        ...
        private void tbTotalCount_TextChanged(object sender, EventArgs e)
        {

        }

        private void spltcntrEdit_Panel2_Paint(object sender, PaintEventArgs e)
        {
