...
namespace ClientcardFB3
{
    ...
    public class HHMembers
    {
        ...
        public int Race
        {
            get { return Convert.ToInt32(drowHhm["Race"]); }
            set { drowHhm["Race"] = value; }
        }
        public bool Hispanic
        {
            get { return (bool)drowHhm["Hispanic"]; }
            set { drowHhm["Hispanic"] = value; }
        }
        public bool BackPack
        {
            get { return (bool)drowHhm["BackPack"]; }
            set { drowHhm["BackPack"] = value; }
        }
        public DateTime BPExpiration
        {
            get { return Convert.ToDateTime(drowHhm["BPExpiration"]); }
            set { drowHhm["BPExpiration"] = value; }
        }
        public int BPSize
        {
            get { return Convert.ToInt32(drowHhm["BPSize"]); }
            set { drowHhm["BPSize"] = value; }
        }
        public int BPSchool
        {
            get { return Convert.ToInt32(drowHhm["BPSchool"]); }
            set { drowHhm["BPSchool"] = value; }
        }
        public string BPNotes
        {
            get { return drowHhm["BPNotes"].ToString(); }
            set { drowHhm["BPNotes"] = value; }
        }
        ...
        {
            get { return Convert.ToInt32(drowHhm["Relationship"]); }
            set { drowHhm["Relationship"] = value; }
        }
        public string Phone
        {
            get { return drowHhm["Phone"].ToString(); }
            set { drowHhm["Phone"] = value; }
        }
        public string EmailAddress
        {
            get { return drowHhm["EmailAddress"].ToString(); }
            set { drowHhm["EmailAddress"] = value; }
        }
        ...
        public bool nameExists(string nameLast, string nameFirst, string dateBirth)
        {
            
            string sqlText = "SELECT COUNT(*) FROM HouseholdMembers WHERE LastName = '" + nameLast + "' AND FirstName = '" + nameFirst + "'";
            if (dateBirth != "")
        ...
        public void newHHMemberSave(HHMemberItem newHHMItem)
        {
