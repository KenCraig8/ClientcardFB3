...
namespace ClientcardFB3
{
    public partial class ServiceItemsForm : Form
    {
        ...
        private void fillForm(int itemKey)
        {
            ...
            cboSvcGrp.SelectedValue = clsSvcItems.DefaultSvcGrp.ToString();
        ...
        private void cboSvcGrp_SelectionChangeCommitted(object sender, EventArgs e)
        {
            if (loadingData == false)
            {
                clsSvcItems.DefaultSvcGrp = Convert.ToInt32(cboSvcGrp.SelectedValue.ToString());
                SaveChangesToDB(false);
            }
        }
