...
namespace ClientcardFB3
{
    class RptGroceryRescue
    {
        ...
        public void createReport(object saveAs, string templatePath, string DonorName, bool isGrouceryRescue, string rptLabel, string rptRange)
        {
            ...
            try
            {
                ...
                m_oSheet.Range["RptLabel", missing].Value = rptLabel;
                m_oSheet.Range["date", missing].Value = rptRange;
                m_oSheet.Range["Agency_Name", missing].Value = CCFBPrefs.FoodBankName;
                m_oSheet.Range["Contact", missing].Value = CCFBPrefs.PreparedBy;
                m_oSheet.Range["Store", missing].Value = DonorName;
