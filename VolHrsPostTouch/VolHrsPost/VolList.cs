...
namespace ClientcardFB3
{
    public partial class VolList : Form
    {
        ...
        public void refresh(string trxdate)
        {
            ...
            conn.Open();
            SqlDataAdapter dadapt = new SqlDataAdapter("SELECT v.Name, vh.VolTimeIN, vh.VolTimeOUT, v.ID FROM Volunteers v INNER JOIN VolunteerHours vh ON v.ID = vh.VolID AND vh.TrxDate = '" + trxdate + "' ORDER BY v.Name", conn);
