...
{
    public partial class MonthlyReportPrefrencesForm : Form
    {
        ...
        public MonthlyReportPrefrencesForm()
        {
            InitializeComponent();
        ...
        private void deleteEmailRecptientsFromReports(string emailAddress)
        {
            ...
            {
                clsMonthlyReports.find(Convert.ToInt32(dataGridViewReports.Rows[i].Cells["clmID"].Value));
