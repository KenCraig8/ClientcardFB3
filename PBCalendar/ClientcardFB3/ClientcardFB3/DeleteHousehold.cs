...
namespace ClientcardFB3
{
    public partial class DeleteHousehold : Form
    {
        ...
        public DeleteHousehold(Client clientIn)
        {
            ...
            CCFBGlobal.InitCombo(cboIDTypeMoveTo, CCFBGlobal.parmTbl_IdVerify);
            ...
            if (clsClientToDelete.clsHHmem.RowCount > 1 || clsClientToDelete.clsHHSvcTrans.RowCount > 0)
            {
            ...
            if (idMoveTo != 0)  // Move Data to Alternate Client Id
            {
                if (clsClientToTransfer.clsHH.ID == idMoveTo)
                {
                    ...
                    if (bNeedToUpdate == true)
                        clsClientToTransfer.clsHH.update();
        ...
        private void btnMarkInactive_Click(object sender, EventArgs e)
        {
            ...
            clsClientToDelete.clsHH.update();
            this.Hide();
        }
    }
}
