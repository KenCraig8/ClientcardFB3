...
namespace ClientcardFB3
{
    public class VolunteerHours
    {
        ...
        public int VolId
        {
            get
            {
                return Convert.ToInt32(drow["VolId"]);
            }
            set
            {
                drow["VolId"] = value;
        ...
        public int NumVolunteers
        {
            get
            {
                return Convert.ToInt32(drow["NumVolunteers"]);
            }
            set
            {
                drow["NumVolunteers"] = value;
            }
        }
        ...
        public Single NumVolHours
        {
            get
            {
                return Convert.ToSingle(drow["NumVolHours"]);
            }
            set
            {
                drow["NumVolHours"] = value;
            }
        }
        ...
        public string VolTimeIn
        {
            get
            {
                return drow["VolTimeIn"].ToString();
            }
            set
            {
                drow["VolTimeIn"] = value;
            }
        }
        ...
        public string VolTimeOut
        {
            get
            {
                return drow["VolTimeOut"].ToString();
            }
            set
            {
                drow["VolTimeOut"] = value;
            }
        }
        #endregion
