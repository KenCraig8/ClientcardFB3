...
namespace ClientcardFB3
{
    public partial class AccessReportsForm : Form
    {
        ...
        private void btnCreateReport_Click(object sender, EventArgs e)
        {
            ...
            if (lvwRptSelector.FocusedItem != null)
            {
                ...
                switch (clsAccessReports.DateRangeType)
                {
                    case 0:
                        {
                            sWhereClause += AddInactiveFlag(sWhereClause);
                    ...
                    case 2: //  "xxx*"
                        {
                            if ((chkAllItems.Visible == true && chkAllItems.Checked == false) || chkAllItems.Visible == false)
                            {
                    ...
                    case 5: //Between #mdy0# AND #mdy1#
                        {
                            ...
                            //Put user selected values into where clause
                            sWhereClause = sWhereClause.Replace("mdy0", dtFrom.Value.ToShortDateString());
                            sWhereClause = sWhereClause.Replace("mdy1", dtTo.Value.ToShortDateString());
                    ...
                    case 6:
                        {
                            sWhereClause = "TrxDate Between #mdy0# AND #mdy1#";
                            sWhereClause = sWhereClause.Replace("mdy0", dtFrom.Value.ToShortDateString());
                            sWhereClause = sWhereClause.Replace("mdy1", dtTo.Value.ToShortDateString());
                            if ((chkAllItems.Visible == true && chkAllItems.Checked == false) || chkAllItems.Visible == false)
                            {
                                ...
                                switch (clsAccessReports.CboResultType)
                                {
                                    case 0:
                                        ...
                                        sWhereClause += " AND " + clsAccessReports.WhereClause.Replace("xxx", tmp);
                                        break;
                                    case 1:
                                        foreach (ListViewItem item in lvwFilter.Items)
                                        {
        ...
        private void createReport(string whereClause, string recordsource)
        {
            ...
            try
            {
                ...
                oAccess.OpenCurrentDatabase(
                   @"C:\ClientcardFB3\ClientcardFB3Reports.accdb", //filepath
                   false //Exclusive
                   );
        ...
        private string AddInactiveFlag(string sOriClause)
        {
            string sRetVal = "";
        ...
        private void loadlvwFilter()
        {
            ...
            try
            {
                ...
                SqlCommand sqlComm = new SqlCommand(clsAccessReports.SqlQuery, conn);
                ...
                if (clsAccessReports.AllowBlank == true)
                {
                    ...
                    chkAllItems.Text = "ALL " + clsAccessReports.LabelLowDate;
